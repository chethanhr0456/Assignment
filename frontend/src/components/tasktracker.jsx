...
const TaskTracker = () => {
    ...
    return (
        <section className="Task_Tracker">
            ...
            <section className='Filter_Task'>
                <fieldset style={{ width: "500px",height:"250px",backgroundColor:"whitesmoke" }} >
                    <legend>Search Task</legend>
                    <h1 style={{margin:"0px",textDecorationLine:'underline'}}>Search Task</h1>
                    <input type="text" placeholder='Search Your Task Here' value={query} onChange={(e) => setquery(e.target.value)} />
                    ...
                    <div className="Date_Time">
                        <label htmlFor="">Start Date & Time:</label> <br />
                        <input type="datetime-local" name="startdate" id="startdate" ref={search_startdate} required /> <br />
                        <label htmlFor="">End Date & Time:</label> <br />
